...
/**
 * A read-only value-transformed view of a [MultiKeyRegistryProjection] that derives a `Map<PK, V>`
 ...
 * the backing [MultiKeyRegistryProjection]. Additional listeners registered on the same backing
 ...
 */
internal class TransformedMultiKeyRegistryProjection<K : Comparable<K>, PK : Comparable<PK>, E : IdentifiableEntity<K>, V>(
